...
public class TestRun1 {
	public static void main(String[] args) {
		...
		System.out.println(p1.getLastName()); // Parent꺼
		System.out.println(p1.hashCode());    // Object꺼
		...
		System.out.println(c1.hashCode());    // Object꺼
		System.out.println(c1.getLastName()); // Parent꺼
		System.out.println(c1.getCar());	  // Child꺼
		...
		System.out.println( p2.hashCode() );    // Object꺼
		System.out.println( p2.getLastName() ); // Parent꺼
